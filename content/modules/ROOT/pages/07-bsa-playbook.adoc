...
[source,bash,run]
----
ansible-playbook -i /home/rhel/hosts.ini /home/rhel/bsa.yml
----
...
* assigning and manage permissions and local *sudo rules*
...
Red Hat also provides the *redhat.rhel_idm collection* for fully automating centralized policy through *Red Hat Identity Management*.
